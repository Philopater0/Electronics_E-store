...
--
-- Host: 127.0.0.1
-- Generation Time: May 14, 2024 at 05:43 AM
...
CREATE TABLE `user_answers` (
  ...
  `Ram` int(50) NOT NULL,
  `Touch` int(50) NOT NULL,
  `OS` int(50) NOT NULL,
  `Inches_min` double NOT NULL,
  `Inches_max` double NOT NULL,
  `cpu_min` int(50) NOT NULL,
  `cpu_max` int(50) NOT NULL,
  `GPU_min` int(50) NOT NULL,
  `GPU_max` int(50) NOT NULL
